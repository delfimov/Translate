...
class Translate
{
    ...
    /**
     * @var array of messages with translations
     */
    ...
    protected function getLanguage()
    {
        if (!isset($this->options['language'])) {
            ...
            foreach ($langs as $key => $lang) {
                if ($lang != '') {
                    ...
                    foreach ($short as $shortValue) {
                        if (empty($this->options['available']) || in_array($shortValue, $this->options['available'])) {
                            if ($max < $q) {
                                $max = $q;
                                $langMax = $shortValue;
                            }
            ...
            if (!empty($language)) {
                if (!empty($this->options['available']) && !in_array($language, $this->options['available'])) {
